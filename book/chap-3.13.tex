...
proof that $h$ is an isomorphism from $N'$ to $N$ is easy.
\end{proof}

\begin{exercise}
Expand on the last sentence of Lemma~\ref{MinimizationLemma8},
proving that $h$ is an isomorphism from $N'$ to $N$ is easy.
\end{exercise}
