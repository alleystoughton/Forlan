...
\index{program!ProgOper@$\ProgOper$}%
  all operators.
\end{itemize}
...
\index{program!described as strings}%
...
\index{Var@\texttt{Var}}%
\index{Var@\texttt{Var}!var@\texttt{var}}%
...
\end{verbatim}
\index{Var@\texttt{Var}!input@\texttt{input}}%
\index{Var@\texttt{Var}!output@\texttt{output}}%
\index{Var@\texttt{Var}!compare@\texttt{compare}}%
\index{Var@\texttt{Var}!equal@\texttt{equal}}%
...
\index{Prog@\texttt{Prog}}%
\index{Prog@\texttt{Prog}!prog@\texttt{prog}}%
...
val toStr   : prog -> str
\end{verbatim}
\index{Prog@\texttt{Prog}!oper@\texttt{oper}}%
\index{Prog@\texttt{Prog}!var@\texttt{var}}%
\index{Prog@\texttt{Prog}!const@\texttt{const}}%
\index{Prog@\texttt{Prog}!int@\texttt{int}}%
\index{Prog@\texttt{Prog}!sym@\texttt{sym}}%
\index{Prog@\texttt{Prog}!str@\texttt{str}}%
\index{Prog@\texttt{Prog}!pair@\texttt{pair}}%
\index{Prog@\texttt{Prog}!calc@\texttt{calc}}%
\index{Prog@\texttt{Prog}!cond@\texttt{cond}}%
\index{Prog@\texttt{Prog}!app@\texttt{app}}%
\index{Prog@\texttt{Prog}!lam@\texttt{lam}}%
\index{Prog@\texttt{Prog}!letSimp@\texttt{letSimp}}%
\index{Prog@\texttt{Prog}!letRec@\texttt{letRec}}%
\index{Prog@\texttt{Prog}!input@\texttt{input}}%
\index{Prog@\texttt{Prog}!output@\texttt{output}}%
\index{Prog@\texttt{Prog}!equal@\texttt{equal}}%
\index{Prog@\texttt{Prog}!height@\texttt{height}}%
\index{Prog@\texttt{Prog}!size@\texttt{size}}%
\index{Prog@\texttt{Prog}!fromStr@\texttt{fromStr}}%
\index{Prog@\texttt{Prog}!toStr@\texttt{toStr}}%
...
\index{program!meaning|(}%
\index{program!variable binding}%
...
\end{verbatim}
\index{Prog@\texttt{Prog}!free@\texttt{free}}%
\index{Prog@\texttt{Prog}!cp@\texttt{cp}}%
\index{Prog@\texttt{Prog}!toClosed@\texttt{toClosed}}%
\index{Prog@\texttt{Prog}!fromClosed@\texttt{fromClosed}}%
...
\index{program!substitution}%
\index{program!subst@$\subst$}%
...
\end{verbatim}
\index{Prog@\texttt{Prog}!subst@\texttt{subst}}%
...
val isValue : cp -> bool
\end{verbatim}
\index{Prog@\texttt{Prog}!isValue@\texttt{isValue}}%
...
\index{program!calculate@$\calculate$}%
...
\index{program!Step@$\Step$}%
\index{program!step@$\step$}%
\index{program!value@$\myvalue$}%
\index{program!error@$\error$}%
\index{program!next@$\next$}%
...
val step : cp -> step
\end{verbatim}
\index{Prog@\texttt{Prog}!step@\texttt{step}}%
\index{Prog@\texttt{Prog}!Value@\texttt{Value}}%
\index{Prog@\texttt{Prog}!Error@\texttt{Error}}%
\index{Prog@\texttt{Prog}!Next@\texttt{Next}}%
...
Let
\index{program!Run@$\Run$}%
\index{program!run@$\run$}%
\index{program!ans@$\ans$}%
\index{program!fail@$\fail$}%
\index{program!intermed@$\intermed$}%
\begin{align*}
...
\end{verbatim}
\index{Prog@\texttt{Prog}!Ans@\texttt{Ans}}%
\index{Prog@\texttt{Prog}!Fail@\texttt{Fail}}%
\index{Prog@\texttt{Prog}!Intermed@\texttt{Intermed}}%
\index{Prog@\texttt{Prog}!run@\texttt{run}}%
\index{Prog@\texttt{Prog}!evaluate@\texttt{evaluate}}%
...
Let
\index{program!Eval@$\Eval$}%
\index{program!eval@$\eval$}%
\index{program!nonterm@$\nonterm$}%
\index{program!error@$\error$}%
\index{program!norm@$\norm$}%
\begin{displaymath}
...
\index{program!representation as data}%
\index{program!Rep@$\Rep$}%
...
\index{program! repr@$\overline{\;\cdot\;}$}%
...
val isRep   : prog -> bool
\end{verbatim}
\index{Prog@\texttt{Prog}!toRep@\texttt{toRep}}%
\index{Prog@\texttt{Prog}!fromRep@\texttt{fromRep}}%
\index{Prog@\texttt{Prog}!isRep@\texttt{isRep}}%
...
\index{program!incremental interpreter}%
...
\index{program!string predicate program}%
\index{string predicate program}%
...
\index{program!string accepted by}%
...
\index{program!meaning}%
\index{program!language accepted by}%
\index{L(@$L(\cdot)$}%
\index{program!L(@$L(\cdot)$}%}%
...
\end{verbatim}
\index{Prog@\texttt{Prog}!accepted@\texttt{accepted}}%
...
\index{language!recursive|see{recursive language}}%
\index{language!recursively enumerable|see{recursively enumerable language}}%
\index{recursive language}%
\index{recursively enumerable language}%
...
We define
\index{recursive language!RecLan@$\RecLan$}%
\index{language!RecLan@$\RecLan$}%
\index{recursively enumerable language!RELan@$\RELan$}%
\index{language!RELan@$\RELan$}%
\begin{align*}
...
\index{context-free language!proper subset of recursive languages}%
\index{recursive language!proper superset of context-free languages}%
\begin{theorem}
