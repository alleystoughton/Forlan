...
\item for all $n\in\nats$ and $x_1,\ldots,x_n\in\{[\,,]\}\cup\Sym$,
  \begin{displaymath}
   [\,\langle\,] @ x_1 @ \cdots @ x_n @ [\,\rangle\,]\in\Sym . 
  \end{displaymath}
\end{itemize}
For example, $[\mathsf{9}]$, $[\,\langle,\,\rangle]$,
$\mathsf{[\,\langle, \,i, \,d, \,\rangle]}$ and
$\mathsf{[\,\langle, \,\langle, \,a, \,,, \,\rangle, \,b, \,\rangle]}$
are symbols.  On the other hand, $[\,\langle,\,\rangle,\,\rangle]$ is
not a symbol.

It is easy to see that, for $x,y\in\List\,\Char$,
if $x\myconcat y\in\Sym$, then exactly one of $x$
and $y$ is $[\,]$.  In other words, a symbol never starts
or ends with another symbol.
