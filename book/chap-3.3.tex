...
\begin{proof}
Follows by Proposition~\ref{CCEquivContext2}.
\end{proof}
...
And, to see that $\beta^*\simp\alpha\beta^*$, it will suffice to
show that $\cc(\beta^*)\ltcc\cc(\alpha\beta^*)$. By the definition
of $\cc$, we have that
\begin{align*}
\cc(\beta^*) &= \overline{\cc\,\beta} , \\  
\cc(\alpha\beta^*) &= \cc\,\alpha \cup \cc(\beta^*) =
  \cc\,\alpha \cup \overline{\cc\,\beta},
\end{align*}
and thus it will suffice to show
$\overline{\cc\,\beta} \ltcc \cc\,\alpha \cup \overline{\cc\,\beta}$.
And
\begin{displaymath}
\overline{\cc\,\beta} \ltcc 
\overline{\cc\,\beta} \cup \cc\,\alpha =
\cc\,\alpha \cup \overline{\cc\,\beta},
\end{displaymath}
by Propositions~\ref{CCLTContext}(3) and \ref{CCEquivContext1}(1).
